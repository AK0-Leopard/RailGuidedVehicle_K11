...
#pragma warning disable CS0414 // 已指派欄位 'uctlCommStatus.lest_start_position_x'，但從未使用過其值。
        int lest_start_position_x = 350;
#pragma warning restore CS0414 // 已指派欄位 'uctlCommStatus.lest_start_position_x'，但從未使用過其值。
