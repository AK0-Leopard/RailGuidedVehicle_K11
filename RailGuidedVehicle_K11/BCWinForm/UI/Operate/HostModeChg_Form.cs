    ...
    public partial class HostModeChg_Form : Form
    {
        ...
        HostControlState HostConn_STAT
        {
            ...
            set
            {
                ...
                else if (hostconn_stat == HostControlState.Host_Offline)
                {
                    setInfo(txtHostMode, "Host offline", Color.Lime, Color.Black);
                }
                ...
                {
                    setInfo(txtHostMode, "On-Line Remote", Color.Green, Color.Black);
                }
            }
        }
        TSCState sc_stat;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            HSMSConn_STAT = scApp.getEQObjCacheManager().getLine().Secs_Link_Stat == SCAppConstants.LinkStatus.LinkOK ? true : false;
        }
