...
namespace com.mirle.ibg3k0.sc.RouteKit
{
    public class FloydAlgorithmRouteGuide : IRouteGuide
    {
        ...
        public FloydAlgorithmRouteGuide(List<ASEGMENT> segments, List<ASECTION> sections, List<AADDRESS> addresses,
            double moveCostForward, double moveCostReverse, string bcID, string algorithm)
        {
            ...
            //        max_path_keep_num = 100;
            //        alternativePathConfig_1.Add(48016);
            //        alternativePathConfig_1.Add(48017);
            //        alternativePathConfig_1.Add(48009);
            //        alternativePathConfig_1.Add(48008);
            //        alternativePathConfig_2.Add(48017);
            //        alternativePathConfig_2.Add(48016);
            //        alternativePathConfig_2.Add(48009);
            //        alternativePathConfig_2.Add(48008);

            //        alternativePathConfig_3.Add(48017);
            //        alternativePathConfig_3.Add(48018);
            //        alternativePathConfig_3.Add(48008);
            //        alternativePathConfig_3.Add(48006);
            //        alternativePathConfig_4.Add(48018);
            //        alternativePathConfig_4.Add(48017);
            //        alternativePathConfig_4.Add(48006);
            //        alternativePathConfig_4.Add(48008);

            //        alternativePathConfig_5.Add(48018);
            //        alternativePathConfig_5.Add(48019);
            //        alternativePathConfig_5.Add(48006);
            //        alternativePathConfig_5.Add(48005);
            //        alternativePathConfig_6.Add(48019);
            //        alternativePathConfig_6.Add(48018);
            //        alternativePathConfig_6.Add(48005);
            //        alternativePathConfig_6.Add(48006);

            //        alternativePathConfig_7.Add(48019);
            //        alternativePathConfig_7.Add(48021);
            //        alternativePathConfig_7.Add(48005);
            //        alternativePathConfig_7.Add(48003);
            //        alternativePathConfig_8.Add(48021);
            //        alternativePathConfig_8.Add(48019);
            //        alternativePathConfig_8.Add(48003);
            //        alternativePathConfig_8.Add(48005);

            //        alternativePathConfig_9.Add(48021);
            //        alternativePathConfig_9.Add(48022);
            //        alternativePathConfig_9.Add(48003);
            //        alternativePathConfig_9.Add(48002);
            //        alternativePathConfig_10.Add(48022);
            //        alternativePathConfig_10.Add(48021);
            //        alternativePathConfig_10.Add(48002);
            //        alternativePathConfig_10.Add(48003);

            //        this.alternativePathConfigList.Add(alternativePathConfig_1);
            //        this.alternativePathConfigList.Add(alternativePathConfig_2);
            //        this.alternativePathConfigList.Add(alternativePathConfig_3);
            //        this.alternativePathConfigList.Add(alternativePathConfig_4);
            //        this.alternativePathConfigList.Add(alternativePathConfig_5);
            //        this.alternativePathConfigList.Add(alternativePathConfig_6);
            //        this.alternativePathConfigList.Add(alternativePathConfig_7);
            //        this.alternativePathConfigList.Add(alternativePathConfig_8);
            //        this.alternativePathConfigList.Add(alternativePathConfig_9);
            //        this.alternativePathConfigList.Add(alternativePathConfig_10);
            //        break;
            //    default:
            //        max_path_keep_num = 30;
            //        alternativePathConfig_1.Add(48093);
            //        alternativePathConfig_1.Add(48095);
            //        alternativePathConfig_1.Add(48023);
            //        alternativePathConfig_1.Add(48018);
            //        alternativePathConfig_2.Add(48095);
            //        alternativePathConfig_2.Add(48093);
            //        alternativePathConfig_2.Add(48018);
            //        alternativePathConfig_2.Add(48023);
            //        alternativePathConfig_3.Add(48117);
            //        alternativePathConfig_3.Add(48116);
            //        alternativePathConfig_3.Add(48121);
            //        alternativePathConfig_3.Add(48120);
            //        alternativePathConfig_4.Add(48116);
            //        alternativePathConfig_4.Add(48117);
            //        alternativePathConfig_4.Add(48120);
            //        alternativePathConfig_4.Add(48121);
            //        this.alternativePathConfigList.Add(alternativePathConfig_1);
            //        this.alternativePathConfigList.Add(alternativePathConfig_2);
            //        this.alternativePathConfigList.Add(alternativePathConfig_3);
            //        this.alternativePathConfigList.Add(alternativePathConfig_4);
            ...
            //alternativePathConfig_4.Add(48120);
            //alternativePathConfig_4.Add(48121);
            //alternativePathConfig_1.Add(25);
            //alternativePathConfig_1.Add(12);
            //alternativePathConfig_1.Add(5);
            //alternativePathConfig_1.Add(4);

            //alternativePathConfig_2.Add(12);
            //alternativePathConfig_2.Add(25);
            //alternativePathConfig_2.Add(4);
            //alternativePathConfig_2.Add(5);

            //alternativePathConfig_3.Add(26);
            //alternativePathConfig_3.Add(13);
            //alternativePathConfig_3.Add(27);
            //alternativePathConfig_3.Add(18);

            //alternativePathConfig_4.Add(13);
            //alternativePathConfig_4.Add(26);
            //alternativePathConfig_4.Add(18);
            //alternativePathConfig_4.Add(27);
            //alternativePathConfigList.Add(alternativePathConfig_1);
            //alternativePathConfigList.Add(alternativePathConfig_2);
            //alternativePathConfigList.Add(alternativePathConfig_3);
            //alternativePathConfigList.Add(alternativePathConfig_4);
            Build(segments, sections, addresses, moveCostForward, moveCostReverse);
        }

        private void Build(List<ASEGMENT> segment, List<ASECTION> sections, List<AADDRESS> addresses, double moveCostForward, double moveCostReverse)
        {
            sectionList = readDataForSectionList(segment, sections, moveCostForward, moveCostReverse);
        ...
        public void reloadRoute(List<ASEGMENT> segments, List<ASECTION> sections, List<AADDRESS> addresses)
        {
            Build(segments, sections, addresses, move_cost_forward, move_cost_reverse);
        }
        ...
        private List<Section> readDataForSectionList(List<ASEGMENT> segments, List<ASECTION> sections, double moveCostForward, double moveCostReverse)
        {
            List<Section> sectionList = new List<Section>();
            foreach (ASEGMENT seg in segments)
            {
                //if (seg.STATUS == E_SEG_STATUS.Closed) continue;
                //if (SCUtility.isEmpty(seg.ADR1_CHG_SEG_ID_1) && SCUtility.isEmpty(seg.ADR1_CHG_SEG_ID_2) && SCUtility.isEmpty(seg.ADR1_CHG_SEG_ID_3) &&
                //    SCUtility.isEmpty(seg.ADR2_CHG_SEG_ID_1) && SCUtility.isEmpty(seg.ADR2_CHG_SEG_ID_2) && SCUtility.isEmpty(seg.ADR2_CHG_SEG_ID_3))
                //{
                //    continue;
                //}
                string section_id = seg.SEG_ID.Trim();
                int address_1 = int.Parse(seg.FROM_ADR_ID);
                int address_2 = int.Parse(seg.TO_ADR_ID);
                //if (isByPass(address_1, address_2)) continue;

                //int moveCost_1 = seg.SEC_COST_From2To;
                //int moveCost_2 = seg.SEC_COST_To2From;
                var on_seg_sections = sections.Where(sec => sec.SEG_NUM.Trim() == seg.SEG_ID.Trim());
                double seg_dis = on_seg_sections.Sum(sec => sec.SEC_DIS);
                //int moveCost_1 = 0;
                //int moveCost_2 = 0;
                int moveCost_1 = seg.SEC_COST_From2To;
                int moveCost_2 = seg.SEC_COST_To2From;

                //double movecostF_weight = 0;
                //double movecostR_weight = 0;
                //DecisionCostWeight(out movecostF_weight, out movecostR_weight);
                double movecostF_weight = moveCostForward;
                double movecostR_weight = moveCostReverse;

                if (seg.DIR == E_RAIL_DIR.F)
                {
                    //M0.05 moveCost_1 = (int)(seg_dis * 0.7);
                    //M0.05 moveCost_2 = (int)seg_dis;
                    //moveCost_1 = (int)(seg_dis * 0.1);//M0.05
                    //moveCost_2 = (int)seg_dis*10;    //M0.05
                    //moveCost_1 = (int)(seg_dis * movecostF_weight);
                    //moveCost_2 = (int)(seg_dis * movecostR_weight);
                    moveCost_1 = moveCost_1 + (int)(seg_dis * movecostF_weight);
                    moveCost_2 = moveCost_2 + (int)(seg_dis * movecostR_weight);
                }
                else
                {
                    //M0.05 moveCost_1 = (int)seg_dis;
                    //M0.05 moveCost_2 = (int)(seg_dis * 0.7);
                    //moveCost_1 = (int)seg_dis * 10;      //M0.05
                    //moveCost_2 = (int)(seg_dis * 0.1);  //M0.05
                    //moveCost_1 = (int)(seg_dis * movecostR_weight);  //M0.05
                    //moveCost_2 = (int)(seg_dis * movecostF_weight);  //M0.05
                    moveCost_1 = moveCost_1 + (int)(seg_dis * movecostR_weight);  //M0.05
                    moveCost_2 = moveCost_2 + (int)(seg_dis * movecostF_weight);  //M0.05
                }
                string changeSec_1 = SCUtility.Trim(seg.ADR1_CHG_SEG_ID_1);
                int interCost_1 = seg.ADR1_CHG_SEG_COST_1;
                string changeSec_2 = SCUtility.Trim(seg.ADR1_CHG_SEG_ID_2);
                int interCost_2 = seg.ADR1_CHG_SEG_COST_2;
                string changeSec_3 = SCUtility.Trim(seg.ADR1_CHG_SEG_ID_3);
                int interCost_3 = seg.ADR1_CHG_SEG_COST_3;
                string changeSec_4 = SCUtility.Trim(seg.ADR2_CHG_SEG_ID_1);
                int interCost_4 = seg.ADR2_CHG_SEG_COST_1;
                string changeSec_5 = SCUtility.Trim(seg.ADR2_CHG_SEG_ID_2);
                int interCost_5 = seg.ADR2_CHG_SEG_COST_2;
                string changeSec_6 = SCUtility.Trim(seg.ADR2_CHG_SEG_ID_3);
                int interCost_6 = seg.ADR2_CHG_SEG_COST_3;
                bool isBanEnd_From2To = seg.ISBANEND_From2To;
                bool isBanEnd_To2From = seg.ISBANEND_To2From;
                int direct = (int)seg.DIR;
