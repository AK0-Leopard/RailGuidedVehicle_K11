...
namespace com.mirle.ibg3k0.sc.Common
{
    ...
    public class SCUtility
    {
        ...
        public static bool isMatche(List<string> list1, List<string> list2)
        {
        ...
        public static bool isMatche(string[] list1, string[] list2)
        {
            if (list1 == null || list2 == null) return false;
            if (list1.Count() != list2.Count()) return false;
            //List1 跟 List2取交集，如果交集的數量與List1(或Lsit2)一樣，代表兩個的List是一樣的
        ...
        public const string MSG_ROLE_CONTROL = "OHxC";
        //public static void RecodeReportInfo(string vhID, IMessage msg, int seqNum)
        //{
        //    AVEHICLE vh_DO = SCApplication.getInstance().getEQObjCacheManager().getVehicletByVHID(vhID);
        //    var fun_name_info = getFunctionNameInfo(msg);

        //    RecodeReportInfo(fun_name_info.msgDirFrom, fun_name_info.msgDirTo, fun_name_info.reNameFunName,
        //        seqNum, vh_DO.VEHICLE_ID, vh_DO.CMD_ID_1, vh_DO.CMD_ID_2, string.Empty,
        //        vh_DO.TRANSFER_ID_1, vh_DO.TRANSFER_ID_2, //S2F49
        //        vh_DO., vh_DO.CurrentSecID, recive_str.EventType.ToString(), (uint)vh_DO.ACC_SEC_DIST, recive_str.RequestBlockID, recive_str.RequestBlockID, //134
        //        0, 0,//134 reply
        //        0,
        //        vh_DO.ACT_STATUS.ToString(),
        //        jsonFormatter.Format(msg),
        //        //recive_str.ToString(),
        //        string.Empty);//144          
        //}
        public static void RecordReportInfo(string msg_from, string msg_to,
        string fun_name, int seq_num, string vh_id, string cmd1, string cmd2, string act_type,
        string transferCmdID1, string transferCmdID2,
        string adr_id, string sec_id, string event_type, uint sec_dis, string reserve_sec_id, string release_block_id,
        int is_reserve_success, int is_hid_pass,
        int travel_dis,
        ...
        string result)
        {
            ...
            logEntry.CST_L = Trim(vh_DO.CST_ID_L, true);
            ...
            logEntry.VH_MODE = vh_DO.MODE_STATUS.ToString();
            logEntry.VH_STATUS = vh_DO.ACT_STATUS.ToString();

            //136 Rep
            logEntry.EVENT_TYPE = Trim(event_type, true);
            logEntry.RESERVE_SEC_ID = Trim(reserve_sec_id, true);
            //136 Reply
            logEntry.IS_RESERVE_SUCCESS = is_reserve_success;
        ...
        public static void RecodeReportInfo(string vh_id, int seq_num, ID_134_TRANS_EVENT_REP recive_str)
        {
            ...
            RecordReportInfo(MSG_ROLE_VH, MSG_ROLE_CONTROL
                , fun_name, seq_num, vh_id, vh_DO.CMD_ID_1, vh_DO.CMD_ID_2, string.Empty,
                vh_DO.TRANSFER_ID_1, vh_DO.TRANSFER_ID_2, //S2F49
        ...
        public static void RecordReportInfo(string vh_id, int seq_num, ID_144_STATUS_CHANGE_REP recive_str)
        {
            AVEHICLE vh_DO = SCApplication.getInstance().getEQObjCacheManager().getVehicletByVHID(vh_id);
            string fun_name = RenameFunName(recive_str);
        ...
        public static void RecodeReportInfo(string vh_id, int seq_num, ID_31_TRANS_REQUEST send_str)
        {
            ...
            RecordReportInfo(MSG_ROLE_VH, MSG_ROLE_CONTROL,
                fun_name, seq_num, vh_id, vh_DO.CMD_ID_1, vh_DO.CMD_ID_2, send_str.CommandAction.ToString(),
                vh_DO.TRANSFER_ID_1, vh_DO.TRANSFER_ID_2, //S2F49
                vh_DO.CUR_ADR_ID, vh_DO.CUR_SEC_ID, string.Empty, (uint)vh_DO.ACC_SEC_DIST, string.Empty, string.Empty, //134
                0, 0,//134 reply
                0,
        ...
        public static void RecodeReportInfo(string vh_id, int seq_num, ID_35_CST_ID_RENAME_REQUEST send_str)
        {
            AVEHICLE vh_DO = SCApplication.getInstance().getEQObjCacheManager().getVehicletByVHID(vh_id);
            string fun_name = RenameFunName(send_str);
        ...
        public static void RecodeReportInfo(string vh_id, int seq_num, ID_135_CST_ID_RENAME_RESPONSE recive_str, string reply_result)
        {
            AVEHICLE vh_DO = SCApplication.getInstance().getEQObjCacheManager().getVehicletByVHID(vh_id);
            string fun_name = RenameFunName(recive_str);
        ...
        public static void RecodeReportInfo(string vh_id, int seq_num, ID_151_AVOID_RESPONSE recive_str, string reply_result)
        {
            AVEHICLE vh_DO = SCApplication.getInstance().getEQObjCacheManager().getVehicletByVHID(vh_id);
            string fun_name = RenameFunName(recive_str);
        ...
        //        sraeamfun_name, send_str.SystemByte, string.Empty, string.Empty, string.Empty,
        //        mcs_cmd_id,                                              //S2F49
        //        string.Empty, string.Empty, string.Empty, 0, string.Empty, string.Empty, //134 rep
        //        0, 0,//134 reply
        //        0,
    ...
    public static class GoogleMessagextension
    {
        public static byte[] ToByteArray(this IMessage gpbObj)
        {
            byte[] arrayByte = new byte[gpbObj.CalculateSize()];
            gpbObj.WriteTo(new Google.Protobuf.CodedOutputStream(arrayByte));
            return arrayByte;
        }
    }
