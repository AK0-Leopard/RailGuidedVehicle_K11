...
namespace com.mirle.ibg3k0.sc
{
    ...
    public partial class HCMD
    {
        public string ID { get; set; }
        public string VH_ID { get; set; }
        public string CARRIER_ID { get; set; }
        public string TRANSFER_ID { get; set; }
        public Nullable<E_CMD_TYPE> CMD_TYPE { get; set; }
        ...
        public Nullable<E_CMD_STATUS> CMD_STATUS { get; set; }
        public Nullable<int> CMD_PROGRESS { get; set; }
        public Nullable<int> INTERRUPTED_REASON { get; set; }
        public Nullable<int> ESTIMATED_TIME { get; set; }
        public Nullable<int> ESTIMATED_EXCESS_TIME { get; set; }
