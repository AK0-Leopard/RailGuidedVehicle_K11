...
{
    public class CMD_DetailDao
    {
        public void add(DBConnection_EF con, ACMD_DETAIL Obj)
        {
            con.ACMD_DETAIL.Add(Obj);
            con.SaveChanges();
        }
        public void AddByBatch(DBConnection_EF con, List<ACMD_DETAIL> cmd_ohtcs)
        {
            con.ACMD_DETAIL.AddRange(cmd_ohtcs);
            con.SaveChanges();
        }


        public void Update(DBConnection_EF con, ACMD_DETAIL cmd_detail)
        {
        ...
        public ACMD_DETAIL getByID(DBConnection_EF con, String cmd_id)
        {
            var query = from cmd in con.ACMD_DETAIL
                        where cmd.CMD_ID == cmd_id.Trim()
                        select cmd;
            return query.FirstOrDefault();
        }
        public ACMD_DETAIL getLastByID(DBConnection_EF con, String cmd_id)
        {
            var query = from cmd in con.ACMD_DETAIL
                        where cmd.CMD_ID == cmd_id.Trim()
        ...
        public ACMD_DETAIL getByCmdIDAndAdrID(DBConnection_EF con, String cmd_id, string adr_id)
        {
            var query = from cmd in con.ACMD_DETAIL
                        where cmd.CMD_ID == cmd_id.Trim()
        ...
        public ACMD_DETAIL getByCmdIDAndSecID(DBConnection_EF con, String cmd_id, string sec_id)
        {
            var query = from cmd in con.ACMD_DETAIL
                        where cmd.CMD_ID == cmd_id.Trim()
        ...
        public ACMD_DETAIL getByCmdIDSECIDAndEntryTimeEmpty(DBConnection_EF con, String cmd_id, string sec_id)
        {
            var query = from cmd in con.ACMD_DETAIL
                        where cmd.CMD_ID == cmd_id.Trim()
                        && cmd.SEC_ID == sec_id.Trim()
        ...
        public ACMD_DETAIL getByCmdIDSECIDAndLeaveTimeEmpty(DBConnection_EF con, String cmd_id, string sec_id)
        {
            var query = from cmd in con.ACMD_DETAIL
                        where cmd.CMD_ID == cmd_id.Trim()
                        && cmd.SEC_ID == sec_id.Trim()
        ...
        {
            var query = from detail in con.ACMD_DETAIL
