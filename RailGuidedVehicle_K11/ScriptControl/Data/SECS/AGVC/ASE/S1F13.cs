...
namespace com.mirle.ibg3k0.sc.Data.SECS.AGVC.ASE
{
    ...
    public class S1F13 : SXFY
    {
        ...
        [SecsElement(Index = 1, Type = SecsElement.SecsElementType.TYPE_ASCII, Length = 6)]//變更長度為6 MarkChou 20190315
        public string MDLN;
        /// <summary>
        /// Software revision code
        /// </summary>
        //[SecsElement(Index = 2, Type = SecsElement.SecsElementType.TYPE_ASCII, Length = 20)]
        [SecsElement(Index = 2, Type = SecsElement.SecsElementType.TYPE_ASCII, Length = 6)]//變更長度為6 MarkChou 20190315
