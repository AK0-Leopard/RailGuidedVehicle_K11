...
namespace com.mirle.ibg3k0.sc.Data.SECS.AGVC.ASE
{
    ...
    public class S2F18 : SXFY
    {
        ...
        [SecsElement(Index = 1, ListSpreadOut = true ,Type = SecsElement.SecsElementType.TYPE_ASCII, Length = 16)]//修改長度為16 MarkChou 20190329
        public string TIME;     //yyyyMMddHHmmsscc
